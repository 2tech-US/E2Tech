 ...
 * Use the {@link AdminDoneOrderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminDoneOrderFragment extends Fragment {
    ...
    public AdminDoneOrderFragment() {
        // Required empty public constructor
    }

    public static AdminDoneOrderFragment newInstance(String param1, String param2) {
        AdminDoneOrderFragment fragment = new AdminDoneOrderFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_admin_done_order, container, false);
        orderList = new ArrayList<>();

        db = FirebaseFirestore.getInstance();

        recyclerView = root.findViewById(R.id.admin_order_recycler_done);
