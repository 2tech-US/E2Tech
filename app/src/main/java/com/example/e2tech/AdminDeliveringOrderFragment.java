 ...
 * Use the {@link AdminDeliveringOrderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminDeliveringOrderFragment extends Fragment {
    ...
    public AdminDeliveringOrderFragment() {
        // Required empty public constructor
    }


    public static AdminDeliveringOrderFragment newInstance(String param1, String param2) {
        AdminDeliveringOrderFragment fragment = new AdminDeliveringOrderFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_admin_delivering_order, container, false);
        orderList = new ArrayList<>();

        db = FirebaseFirestore.getInstance();

        recyclerView = root.findViewById(R.id.admin_order_recycler_delivering);
